...
- **Customizable Rotation Frequency:** Set how often the URL changes, whether it’s every few minutes or once a day (ideal for use with Vercel Cron Jobs).
...
import { rotateLink, verifyToken } from 'neix';

const secureLink = rotateLink('/admin', rotationFrequency);

// When accessing the admin route
