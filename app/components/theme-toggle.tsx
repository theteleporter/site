      ...
      <div className="flex gap-0.5">
        <button
          ...
          className={`rounded-full p-1 transition-colors ${
            resolvedTheme === "system" ? "text-white bg-[#333] border border-[#6F6F6F]" : "text-[#8C8C8C] hover:text-white"
          }`}
        ...
        <button
          ...
          className={`rounded-full p-1 transition-colors ${
            resolvedTheme === "light" ? "text-white bg-[#333] border border-[#6F6F6F]" : "text-[#8C8C8C] hover:text-white"
          }`}
        ...
        <button
          ...
          className={`rounded-full p-1 transition-colors ${
            resolvedTheme === "dark" ? "text-white bg-[#333] border border-[#6F6F6F]" : "text-[#8C8C8C] hover:text-white"
          }`}
